...
<head>
    ...
    <title>Aktivácia účtu – Evidencia odbornej praxe</title>
</head>
<body
...
>
    ...
    <div style="padding: 36px 32px;">
        <h2 style="font-size: 20px; color: #111827; margin-bottom: 16px;">Aktivácia účtu</h2>

        <p style="font-size: 16px; color: #374151; line-height: 1.6;">
            Dobrý deň {{ $user->name }},<br /><br />
            ďakujeme za registráciu. Pre dokončenie registrácie a aktiváciu Vášho účtu si, prosím,
            nastavte heslo kliknutím na odkaz nižšie.
        </p>
